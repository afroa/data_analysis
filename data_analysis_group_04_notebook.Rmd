...
We did the calculations to find the total population of each racial demographic in the state without kids by hand, using the console in R as a workaround to the code issues we were having. It was the most efficient way forward for us.
