...
None of these figures added up to 100% of the population, even after taking out the number of kids that would have been present in the state population data. Taking out the number of kids also did not substantively change what populations were the most likely to own or rent homes in Prince George's County based on the figures that we used from the Census data. This makes us wonder what else we possibly could have done to make our data sum up to a correct amount. 
