...
# Finding Native homeowners - using Hawaiian as a proxy this makes literally no sense, so this data is a wash
...
# These are the figures of home ownership before we took out the population of kids of each race in each county and summed those figures. 
...
# These are the figures for home ownership and home rentership that were present after we manually did calculations subtracting the under 18 population of each race from the total population of each race in the county.
...
# 691+205266+75827+3241+416120+656618 = 1,357,763


# asian-owners-no-kids: 28.19
# asian-renters-no-kids: 12.08

# white-owners-no-kids: 37%
# white-renters-no-kids: 12%

# native-owners-no-kids: 28%
# native-renters-no-kids: 22%

# hawaiian/pacific-owners-no-kids:  24%
# hawaiian/pacific-renters-no-kids:  17%

# black-owners-no-kids: 24%
# black-renters-no-kids: 22.8%

# hispanic-owners-no-kids:  roughly no change
# hispanic-renters-no-kids: roughly no change  
...
# From original Q5 response: We acknowledge the discrepancies in the total ownership and rentership numbers, and will be exploring this further by comparing those stats to a different ACS variable of total population of people in each demographic category over the age of 18, to see how the numbers change. This would make sense that the numbers may be different because people under 18 cannot own or rent homes. The ACS variable we select will reflect populations 18 years and older.

Update to question 5 based on filtering out of children data:


We did the calculations to find the total population of each racial demographic in the state without kids by hand, using the console in R as a workaround to the code issues we were having. It was the most efficient way forward for us given the limited time we had to allocate towards this side quest of question #5.

The number of Asians with no kids who rent vs. own a house isn't too far off from the total population of the race that rents vs. owns a house. 12.08% of Asians without kids rented compared to the race's total of 9.66%. 28.19% of Asians without kids owned a house when subtracting the number of kids from the figures, compared to 22.54% from the race's total population.

The case was the same with all other races in census data, Blacks, and Whites. On average, there were disparities of between 4% and 6% when comparing how much of the total population rented vs. owned a home with how much of the population that owned kids rented vs. owned a home.

For Hispanics, our calculations didn't yield data we could discuss authoritatively and this points to the Census Bureau's inefficiency in counting the population well. This is because of the aforementioned issue of the Census not collecting Hispanic-only population data, so the change was mute when we were subtracting a smaller Hispanic kid population from a huge white population in the state. 

None of these figures added up to 100% of the population, even after taking out the number of kids that would have been present in the state population data. Taking out the number of kids also did not substantively change what populations were the most likely to own or rent homes in the state based on the figures that we used from the Census data. This makes us wonder what else we possibly could have done to make our data sum up to a correct amount. 

We would have loved to pursue inquiries into Prince George's County specifically using this data, but we ran out of time during class today and do not have the bandwidth as a group to keep analyzing the data past this, especially because of our consideration of a sixth question. 
